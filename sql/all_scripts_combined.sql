...
\copy staging.synthetic_warehouse
    FROM 'original_data_files/synthetic_warehouses.csv'
    WITH (FORMAT csv, HEADER true);

\copy staging.synthetic_shipments
    FROM 'original_data_files/synthetic_shipments.csv'
    WITH (FORMAT csv, HEADER true);
...
\copy staging.orders TO 'docs/final_csv_exports/staging_orders.csv' WITH (FORMAT csv, HEADER true);

\copy staging.customers TO 'docs/final_csv_exports/staging_customers.csv' WITH (FORMAT csv, HEADER true);
\copy staging.order_items TO 'docs/final_csv_exports/staging_order_items.csv' WITH (FORMAT csv, HEADER true);
\copy staging.order_payments TO 'docs/final_csv_exports/staging_order_payments.csv' WITH (FORMAT csv, HEADER true);
\copy staging.reviews TO 'docs/final_csv_exports/staging_reviews.csv' WITH (FORMAT csv, HEADER true);
\copy staging.products TO 'docs/final_csv_exports/staging_products.csv' WITH (FORMAT csv, HEADER true);
\copy staging.product_category_name_translation TO 'docs/final_csv_exports/staging_product_category_name_translation.csv' WITH (FORMAT csv, HEADER true);
\copy staging.sellers TO 'docs/final_csv_exports/staging_sellers.csv' WITH (FORMAT csv, HEADER true);
\copy staging.geolocation TO 'docs/final_csv_exports/staging_geolocation.csv' WITH (FORMAT csv, HEADER true);
\copy staging.synthetic_warehouse TO 'docs/final_csv_exports/staging_synthetic_warehouse.csv' WITH (FORMAT csv, HEADER true);
\copy staging.synthetic_shipments TO 'docs/final_csv_exports/staging_synthetic_shipments.csv' WITH (FORMAT csv, HEADER true);

\copy dw.dim_customer TO 'docs/final_csv_exports/dim_customer.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_product TO 'docs/final_csv_exports/dim_product.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_seller TO 'docs/final_csv_exports/dim_seller.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_date TO 'docs/final_csv_exports/dim_date.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_geolocation TO 'docs/final_csv_exports/dim_geolocation.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_category TO 'docs/final_csv_exports/dim_category.csv' WITH (FORMAT csv, HEADER true);
\copy dw.dim_warehouse TO 'docs/final_csv_exports/dim_warehouse.csv' WITH (FORMAT csv, HEADER true);
\copy dw.fact_orders TO 'docs/final_csv_exports/fact_orders.csv' WITH (FORMAT csv, HEADER true);
\copy dw.fact_order_items TO 'docs/final_csv_exports/fact_order_items.csv' WITH (FORMAT csv, HEADER true);
\copy dw.fact_payments TO 'docs/final_csv_exports/fact_payments.csv' WITH (FORMAT csv, HEADER true);
\copy dw.fact_reviews TO 'docs/final_csv_exports/fact_reviews.csv' WITH (FORMAT csv, HEADER true);
\copy dw.fact_shipments TO 'docs/final_csv_exports/fact_shipments.csv' WITH (FORMAT csv, HEADER true);
